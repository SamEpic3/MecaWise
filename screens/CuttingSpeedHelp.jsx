...
export default function CuttingSpeedHelp() {
    ...
    const helpData = [
        ...
        },
        {
            ...
            "Vous verrez son nom ainsi que les valeurs SFM pour un outil carbure et pour un outil HSS."
        },
        {
            ...
            "Entrez un nom et les valeurs de SFM pour votre matériau. Appuyez sur le crochet en haut à droite pour sauvegarder."
        },
        {
        ...
        },
        {
            ...
            text: "Si le diamètre donné est en pouce, la formule pour calculer le rpm est la suivante : (4 * SFM) / diamètre"
        },
    ];
